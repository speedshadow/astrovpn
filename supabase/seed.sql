...
INSERT INTO public.vpns (
  ...
  show_on_homepage, full_review, speed_test_results
) VALUES
(
  ...
  TRUE, '<h3>Full NordVPN Review</h3><p>NordVPN is a powerhouse in the VPN industry, and for good reason...</p>', '[{"country": "USA", "speed": 95}, {"country": "UK", "speed": 92}, {"country": "Japan", "speed": 88}]'
),
(
  ...
  FALSE, NULL, NULL,
  TRUE, '<h3>Full ExpressVPN Review</h3><p>ExpressVPN consistently ranks as one of the best VPNs available...</p>', '[{"country": "USA", "speed": 92}, {"country": "UK", "speed": 89}, {"country": "Germany", "speed": 90}]'
),
(
  ...
  TRUE, '<h3>Full Surfshark Review</h3><p>Surfshark has quickly become a fan favorite for its combination of price and features...</p>', '[{"country": "USA", "speed": 85}, {"country": "Australia", "speed": 82}, {"country": "Canada", "speed": 84}]'
)
ON CONFLICT (slug) DO NOTHING;
