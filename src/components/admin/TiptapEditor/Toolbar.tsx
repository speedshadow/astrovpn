...
import {
  Bold, Italic, Strikethrough, List, ListOrdered, Heading1, Heading2, Heading3, Heading4, Pilcrow, Quote, Image as ImageIcon, Table, AlignLeft, AlignCenter, AlignRight
} from 'lucide-react';
  ...
  return (
    <div className="toolbar">
      ...
      >
       ...
       <div className="toolbar-divider"></div>
      <button type="button" onClick={handleImageClick} className="toolbar-button">
