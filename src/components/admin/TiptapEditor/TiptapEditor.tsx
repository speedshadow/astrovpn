...
const TiptapEditor: React.FC<TiptapEditorProps> = ({ value, onChange }) => {
  const editor = useEditor({
    extensions: [
      ...
      TableHeader.configure({
        HTMLAttributes: {
          class: 'bg-gray-100 dark:bg-gray-700 font-bold p-2 border border-gray-300 dark:border-gray-600',
        }
      }),
      TextAlign.configure({
  ...
  return (
    <div>
      ...
      <pre style={{ marginTop: 16, background: '#f3f4f6', color: '#111', padding: 12, borderRadius: 8, fontSize: 13, overflowX: 'auto' }}>
