...
export const ReviewDashboard = ({ initialReviewPages }: ReviewDashboardProps) => {
            ...
            {reviewPages.length > 0 ? (
              reviewPages.map((page) => (
                <TableRow key={page.id}>
                  ...
                  <TableCell>
                    <a href={`/reviews/${page.slug}`} className="hover:underline" target="_blank" rel="noopener noreferrer">
                      /reviews/{page.slug}
                    </a>
                  </TableCell>
