...
export const VpnComparison: React.FC<VpnComparisonProps> = ({ vpns }) => {
  ...
  const selectedVpns = useMemo(() => {
    return selectedIds.map(id => vpns.find(vpn => vpn.id === id)).filter(Boolean) as Vpn[];
  }, [selectedIds, vpns]);
                    ...
                    {selectedVpns.map(vpn => (
                      <TableCell key={vpn.id} className="text-center text-base">
                        {(() => {
                          ...
                          if (feature.key === 'price_monthly' && typeof value === 'number') {
                  ...
                  {selectedVpns.map(vpn => (
                    <TableCell key={vpn.id} className="text-center">
                      ...
                      <Button asChild className="w-full">
                        <a href={vpn.affiliate_link} target="_blank" rel="noopener noreferrer nofollow">
                          Visit Site
                        </a>
                      </Button>
                    )}
