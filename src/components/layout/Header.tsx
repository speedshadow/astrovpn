...
import { Menu, Shield, Star, Trophy, BarChart, FileText, PlayCircle, Wrench, ChevronDown } from 'lucide-react';
  ...
  items: [
    {
      ...
      icon: PlayCircle,
      description: 'Unblock your favorite shows and movies from anywhere in the world.'
    },
  ...
  items: [
    {
      ...
      icon: Shield,
      description: 'Check for IP, DNS, and WebRTC leaks to ensure your VPN is working correctly.'
    },
    {
      title: 'VPN Comparator',
      href: '/vpn-comparator',
      icon: BarChart,
      description: 'Compare VPNs side-by-side to find the best one for your needs.'
    },
  ]
};
...
export function Header({ vpnLinks }: HeaderProps) {
  ...
  return (
    <header className={`sticky top-0 z-50 w-full transition-all duration-300 ${isScrolled ? 'border-b bg-background/95 backdrop-blur-sm' : 'bg-transparent'}`}>
